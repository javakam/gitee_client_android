...
public class StatusBarUtils {
    ...
    private static boolean supportTranslucent() {
        return Build.VERSION.SDK_INT >= KITKAT
                ...
                && !(OSUtils.isEssentialPhone() && Build.VERSION.SDK_INT < 26);
    }
    ...
    public static void translucent(Window window, @ColorInt int colorOn5x) {
        ...
        if (OSUtils.isMeizu() || (OSUtils.isMIUI() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M)) {
...
//            }
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        if (OSUtils.isMIUIV9() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            return true;
        }
        return OSUtils.isMIUIV5() || OSUtils.isMIUIV6() ||
                OSUtils.isMIUIV7() || OSUtils.isMIUIV8();
    }
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(OSUtils.isZUKZ1() || OSUtils.isZTKC2016());
    }
