 ...
 * <p>
 * Description: Modify from {@link android.os.AsyncTask}
 * <pre>
 *     usage:
 *
...
public class ThreadProvider {
    ...
    private static final String TAG = "ThreadProvider";
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable runnable) {
            return new Thread(runnable, Thread.currentThread().getName() + " AsyncTask # " + mCount.getAndIncrement());
        }
    };
    ...
    static {
        ...
        L.d(TAG, "自定义线程池的配置：" + "CORE_POOL_SIZE: " + CORE_POOL_SIZE + "  MAXIMUM_POOL_SIZE: " + MAXIMUM_POOL_SIZE
